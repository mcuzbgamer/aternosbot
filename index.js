...
const pswd = "Komiljon2025";
const username = "KomiljonHelper";

const p1 = [2726, 108, 1885];
const p2 = [2727, 108, 1880];
...
function createBot() {
    ...
    bot.once('spawn', async () => {
        ...
        setTimeout(() => {
            ...
            bot.pathfinder.setGoal(new GoalNear(2726, 107, 1886, 1));  // Yangi maqsad
